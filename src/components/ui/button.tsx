...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[12px] text-sm font-semibold transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-95 hover:-translate-y-1",
  {
    variants: {
      variant: {
        default: "gradient-bg text-white shadow-lg hover:shadow-xl glow-purple",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 shadow-lg hover:shadow-xl focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
        outline:
          "border-2 border-primary/30 bg-card text-foreground hover:bg-primary/10 hover:border-primary shadow-md hover:shadow-lg",
        secondary:
      ...
      size: {
        ...
        sm: "h-9 rounded-[10px] gap-1.5 px-4 has-[>svg]:px-3",
        lg: "h-14 rounded-[16px] px-8 text-base has-[>svg]:px-6",
